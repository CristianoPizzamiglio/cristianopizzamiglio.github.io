...
1. Visit the [Hugging Face Inference Endpoint](https://endpoints.huggingface.co/) website.

2. Sign up to create an account or log in.

3. Click the **+ New** button in your Inference Endpoint dashboard.
...
To test the application, I have used the [`point-picker-3d`](https://github.com/CristianoPizzamiglio/point-picker-3d), a simple interface to pick points on a geometry file (e.g. stl, ply, obj, etc.) and to export the coordinates to a csv file.
